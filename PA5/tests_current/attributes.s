...
#ANN(COOLCLASS, "A","Object", "IO")
  #ANN(COOLMETHOD, "A", "init", "SELF_TYPE")
#ANN(COOLCLASS, "B","Object", "Int", "A", "IO")
  #ANN(COOLMETHOD, "B", "init", "SELF_TYPE")
  #ANN(COOLMETHOD, "B", "doSomething", "Int")
#ANN(COOLCLASS, "Main","IO", "B")
