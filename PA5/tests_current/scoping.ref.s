...
#ANN(COOLCLASS, "Bob","IO", "Int", "Int")
#ANN(COOLCLASS, "Main","Bob", "Int")
  #ANN(COOLMETHOD, "Main", "jack", "Int", "Int", "Int")
  #ANN(COOLMETHOD, "Main", "print_z", "Int", "SELF_TYPE")
  #ANN(COOLMETHOD, "Main", "main", "Bob")
	.data
	.align	2
	.globl	class_nameTab
	.globl	Main_protObj
