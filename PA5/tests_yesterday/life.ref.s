...
#ANN(COOLCLASS, "Board","IO", "Int", "Int", "Int")
  #ANN(COOLMETHOD, "Board", "size_of_board", "String", "Int")
  #ANN(COOLMETHOD, "Board", "board_init", "String", "SELF_TYPE")
#ANN(COOLCLASS, "CellularAutomaton","Board", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "init", "String", "SELF_TYPE")
  #ANN(COOLMETHOD, "CellularAutomaton", "print", "SELF_TYPE")
  #ANN(COOLMETHOD, "CellularAutomaton", "num_cells", "Int")
  #ANN(COOLMETHOD, "CellularAutomaton", "cell", "Int", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "north", "Int", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "south", "Int", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "east", "Int", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "west", "Int", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "northwest", "Int", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "northeast", "Int", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "southeast", "Int", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "southwest", "Int", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "neighbors", "Int", "Int")
  #ANN(COOLMETHOD, "CellularAutomaton", "cell_at_next_evolution", "Int", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "evolve", "SELF_TYPE")
  #ANN(COOLMETHOD, "CellularAutomaton", "option", "String")
  #ANN(COOLMETHOD, "CellularAutomaton", "prompt", "Bool")
  #ANN(COOLMETHOD, "CellularAutomaton", "prompt2", "Bool")
#ANN(COOLCLASS, "Main","CellularAutomaton", "CellularAutomaton")
