...
#ANN(COOLCLASS, "Base","IO")
  #ANN(COOLMETHOD, "Base", "identify", "Object")
#ANN(COOLCLASS, "Derived","Base")
  #ANN(COOLMETHOD, "Derived", "out_string", "String", "SELF_TYPE")
#ANN(COOLCLASS, "Main","Object")
  #ANN(COOLMETHOD, "Main", "main", "Object")
	...
	.globl	Base_init
	.globl	Base_attrTab
	.globl	Derived_protObj
	.globl	Derived_init
	.globl	Derived_attrTab
_int_tag:
	.word	4
_bool_tag:
	.word	5
